    ...
    if (validateProfile()) {
      try {
        ...
        if (response.status === 200 && response.data) {
          ...
          toast.success("Prfoile updated successfully");
          navigate("/chat");
        }
      } catch (error) {
        console.log("error in prifle UPDATE api ", error);
      }
    }
  };
          ...
          <div className="flex min-w-32 md:min-w-64 flex-col gap-5 text-white items-center justify-center">
            <div className="w-full">
              <Input
                ...
                className="rounded-lg p-6 bg-[#2c2e3b] border-none my-4"
              />
              <Input
